          ...
          <div className="flex items-center gap-4 flex-shrink-0">
            ...
            <div className="relative hidden lg:block">
              <input
                ...
                className="rounded-lg px-4 py-2 pr-10 text-sm bg-gray-100 text-gray-700 placeholder-gray-500 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#8B0000] w-48 transition-colors"
              />
            ...
            {isAuthenticated ? (
              ...
              <div className="flex items-center gap-3">
                <Link
                  href="/login"
                  className="px-4 py-2 font-sans text-sm text-gray-600 hover:text-gray-900 transition-colors"
                >
                  Login
                </Link>
                <Link
